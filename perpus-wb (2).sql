...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2020 at 06:12 AM
...
(17, 'Azka Dini Yuntari', '081973249144', 'azkady1930@gmail.com', 'Perum Puri Pesona Blok B14 RT009/RW004 Kel.Bojong Pondok Terong Kec.Cipayung Kota Depok', 'master', 'azkady', '7091092255ebc28ebc48ac45b2dbc0bfeff9c1ca', 'image/jpeg','', '2020-03-30 10:02:12');
INSERT INTO `admin` (`id_admin`, `nama`, `notlp`, `email`, `alamat`, `role`, `username`, `password`, `mime`, `foto`, `timestamp`) VALUES
...
('1322347455', 'azka', '$2y$14$kefF6aqkuOEWo7CIFduNf.7O8BuGR4uWrIAFcHWm2u99OcLPDFWOe', 'ccit 6b', 'azka@gmail.com', '098765', 'Citayam', '');
INSERT INTO `anggota` (`no_anggota`, `nama`, `password`, `kelas`, `email`, `no_telpon`, `alamat`, `foto`) VALUES
...
INSERT INTO `katalog` (`no_katalog`, `no_klasifikasi`, `no_koleksi`, `jenis_katalog`, `judul`, `pengarang`, `penerbit`, `kota_terbit`, `tahun_terbit`, `isbn`, `lokasi`, `absktrak`, `tanggal_masuk`, `e_book`, `cover`, `stok`) VALUES
('002', '2', '2', 'E-Book', 'Jackson', 'Pinurbo', 'Media', 'Depok', '2018', '0987654', 'Rak 2', 'Paragraf adalah bagian dari suatu karangan yang terdiri atas sejumlah kalimat yang mengungkapkan satuan informasi dengan ide pokok sebagai pengendalinya (Ramlan). Paragraf adalah serangkaian kalimat yang saling bertalian untuk membuat sebuah ide atau gagasan baru (Handayani dkk)', '2020-04-04','', '', 10);
INSERT INTO `katalog` (`no_katalog`, `no_klasifikasi`, `no_koleksi`, `jenis_katalog`, `judul`, `pengarang`, `penerbit`, `kota_terbit`, `tahun_terbit`, `isbn`, `lokasi`, `absktrak`, `tanggal_masuk`, `e_book`, `cover`, `stok`) VALUES
...
--
ALTER TABLE `kunjungan`
  MODIFY `no_kunjungan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `logadmin`
--
ALTER TABLE `logadmin`
  MODIFY `id_log_admin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
