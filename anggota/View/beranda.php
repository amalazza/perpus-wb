...
<!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-secondary mb-0"><b>Buku Terbaru</b></h2>
  ...
  <section class="page-section portfolio" id="portfolio" style="margin-top: -90px;">
    <div class="container" style=" margin-top: -38px;">
<!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-secondary mb-0"><b>Buku Populer</b></h2>
      ...
      <!-- Portfolio Grid Items -->
      <div class="row">
        <?php if (empty($this->oBukuP)): ?>
        <?php else: ?>
        <?php foreach ($this->oBukuP as $oBuku):
        $absktrak = substr($oBuku->absktrak, 0, 250) . '...';
        $judul = substr($oBuku->judul, 0, 30) . '...';
        $pengarang = substr($oBuku->pengarang, 0, 30);
  ...
  <section class="page-section portfolio" id="portfolio" style="margin-top: -90px;">
    <div class="container" style=" margin-top: -38px;">
<!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-secondary mb-0"><b>E-Book Populer</b></h2>
      ...
      <!-- Portfolio Grid Items -->
      <div class="row">
        <?php if (empty($this->oBukuB)): ?>
        <?php else: ?>
        <?php foreach ($this->oBukuB as $oBuku):
        $absktrak = substr($oBuku->absktrak, 0, 250) . '...';
        $judul = substr($oBuku->judul, 0, 30) . '...';
        $pengarang = substr($oBuku->pengarang, 0, 30);
  ...
  <section class="page-section portfolio" id="portfolio" style="margin-top: -90px;">
    <div class="container" style=" margin-top: -38px;">
<!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-secondary mb-0"><b>Buku Favorite</b></h2>
      ...
      <!-- Portfolio Grid Items -->
      <div class="row">
        <?php if (empty($this->oBukuF)): ?>
        <?php else: ?>
        <?php foreach ($this->oBukuF as $oBuku):
        $absktrak = substr($oBuku->absktrak, 0, 250) . '...';
        $judul = substr($oBuku->judul, 0, 30) . '...';
        $pengarang = substr($oBuku->pengarang, 0, 30);
