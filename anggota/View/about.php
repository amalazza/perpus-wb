...
<center>
      ...
      <h3 class="page-section-heading text-center text-secondary mb-0" style="margin-top: 7px;">SMK WIRA BUANA 1 | SMK WIRA BUANA 2</h3>
	</center>
	...
	<!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-secondary mb-0">Tentang Perpustakaan</h2>
