...
class Detail
{
    ...
    public function __construct()
    {
        ...
        $this->oUtil->getModel('Detail');
        $this->oModel = new \TestProject\Model\Detail;
    ...
    public function index()
    {
        ...
        $this->oUtil->oDetail = $this->oModel->get(0, self::MAX_POSTS); // Get only the latest X posts
    ...
    {
        $this->oUtil->oDetail = $this->oModel->getById($this->_iId); // Get the data of the post
